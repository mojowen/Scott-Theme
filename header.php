...
<body <?php body_class(); ?>>
  ...
  <div id="page" >
    ...
    <sidebar id="side">
        <a id="photo" href="/about"><img src="<?php echo srd_default_thumbnail(); ?>"></a>
    	<h4 id="description"><?php echo get_bloginfo('description'); ?></h4>
    	<a id="about" href="/about">What does that mean?</a>
        <a id="projects_link" href="/">Here's some stuff I've built</a>
    	<div id="social">
    		<a href="mailto:me@scottduncombe.com">email</a>
